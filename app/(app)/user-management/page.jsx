        ...
        <motion.main variants={pageFx} initial="hidden" animate="show" className="min-h-screen p-4 sm:p-6 lg:p-8 overflow-y-auto bg-[var(--background)]">
                            ...
                            {filteredUsers.map((user) => (
                                ...
                                >
                                    ...
                                    <div className="absolute top-3 right-3 flex gap-2">
                                        <button className="p-1 rounded hover:bg-gray-100 cursor-pointer" style={{ color: "var(--text-secondary)" }} onClick={() => openEdit(user)}>
                                            <Edit className="h-4 w-4" />
                                        </button>
                                        <button className="p-1 rounded hover:bg-gray-100 cursor-pointer" style={{ color: "var(--text-secondary)" }} onClick={() => openDelete(user)}>
                                    ...
                                    <div className="p-6">
                                        ...
                                        <div className="space-y-2 mb-6 text-sm" style={{ color: "var(--text-secondary)" }}>
                                            <div className="flex gap-2 items-center"><Mail className="h-4 w-4" /> {user.email}</div>
                                            <div className="flex gap-2 items-center"><Shield className="h-4 w-4" /> {user.role || "Member"}</div>
                                            <div className="flex gap-2 items-center"><Calendar className="h-4 w-4" /> {user.created_at}</div>
                                        </div>
                                        ...
                                        <div className="flex gap-4">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div className="text-xs" style={{ color: "var(--text-tertiary)" }}>
                                                    {user.email} • {user.role || "Member"} • {user.created_at}
                                                </div>
                                            </div>
            ...
            {users.length === 0 && !searchTerm && (
                ...
                >
                    ...
                    >
                        Create your first user to enable semantic search across
                        your data.
                    </p>
                    <motion.button
                        whileHover={{ scale: 1.02 }}
                                ...
                                <div className="px-5 pt-3 pb-5">
                                    ...
                                    >
                                        ...
                                        <div className="mt-1 text-xs" style={{ color: "var(--text-tertiary)" }}>
                                            {selectedUser?.email} • {selectedUser?.role || "Member"} • {selectedUser?.created_at}
                                        </div>
                                    </div>
