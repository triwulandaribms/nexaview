                ...
                <div className="sticky top-0 z-40 -mx-4 sm:-mx-6 lg:-mx-8">
                    <div className="px-4 sm:px-6 lg:px-8 py-3 border-b" style={{ borderColor: "var(--border-light)" }}>
                        <div className="flex items-center gap-3">
                            <div className="h-9 w-9 rounded-lg border animate-pulse" style={{ background: "var(--surface-elevated)", borderColor: "var(--border-light)" }} />
                            ...
                            <div className="space-y-5">
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="text-sm" style={{ color: "var(--text-secondary)" }}>Full name</div>
                                        <div className="font-medium truncate" style={{ color: "var(--text-primary)" }}>{user.fullName}</div>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="font-medium break-words" style={{ color: "var(--text-primary)" }}>{user.email}</div>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="text-sm" style={{ color: "var(--text-secondary)" }}>Mobile number</div>
                                        <div className="font-medium truncate" style={{ color: "var(--text-primary)" }}>{user.mobile}</div>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="font-medium" style={{ color: "var(--text-primary)" }}>{user.role}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-4 sm:p-6">
                            ...
                            <div className="space-y-3 text-sm">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <span style={{ color: "var(--text-primary)" }}>{user.createdAt}</span>
                                </div>
                                <div className="flex items-center justify-between">
                                    <span style={{ color: "var(--text-secondary)" }}>Last updated</span>
                                    <span style={{ color: "var(--text-primary)" }}>{user.updatedAt}</span>
                                </div>
                                <div className="flex items-center justify-between">
                                    <span style={{ color: "var(--text-secondary)" }}>Last login</span>
                                    <span style={{ color: "var(--text-primary)" }}>{user.lastLogin}</span>
                                </div>
                            </div>
                        </div>
                    </div>
